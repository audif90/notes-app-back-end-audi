class AuthenticationsHandler {
    constructor(authenticationsService, usersService, tokenManager, validator) {
        ...
        this.postAuthenticationHandler = this.postAuthenticationHandler(bind)
        this.putAuthenticationHandler = this.putAuthenticationHandler(bind)
    ...
    async postAuthenticationHandler(request, h) {
        try {
            ...
            const response = h.response({
                status: 'success',
                message: 'Authenticaiton berhasil ditambahkan',
                data: {
                    accessToken,
                    refreshToken
                }
